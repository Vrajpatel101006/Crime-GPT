        ...
        <table className="table">
          <thead>
            <tr>
              ...
              <th style={{ cursor: 'pointer', userSelect: 'none' }} onClick={() => handleSort('firNumber')}>FIR Number<SortIcon col="firNumber" /></th>
              <th style={{ cursor: 'pointer', userSelect: 'none' }} onClick={() => handleSort('crimeType')}>Crime Type<SortIcon col="crimeType" /></th>
              <th>Classification</th>
              <th>Victim</th>
              <th style={{ cursor: 'pointer', userSelect: 'none' }} onClick={() => handleSort('status')}>Status<SortIcon col="status" /></th>
              <th style={{ cursor: 'pointer', userSelect: 'none' }} onClick={() => handleSort('readinessScore')}>Readiness<SortIcon col="readinessScore" /></th>
              <th style={{ cursor: 'pointer', userSelect: 'none' }} onClick={() => handleSort('createdAt')}>Date<SortIcon col="createdAt" /></th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
