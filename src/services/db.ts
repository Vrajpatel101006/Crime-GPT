...
const USE_MOCK = import.meta.env.VITE_USE_MOCK_DB === 'true';
...
export async function createCase(caseData: Record<string, any>): Promise<void> {
...
export async function createEvidence(evidence: Record<string, any>): Promise<void> {
...
export async function createDocument(doc: Record<string, any>): Promise<void> {
...
export async function addDiaryEntry(caseId: string, entry: Record<string, any>): Promise<void> {
...
export async function addAuditLog(log: Record<string, any>): Promise<void> {
...
export async function addNotification(notif: Record<string, any>): Promise<void> {
